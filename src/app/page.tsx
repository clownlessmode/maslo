...
function HomePage() {
  return (
    <div className="flex md:flex-row flex-col-reverse w-full gap-5 px-10 pb-[calc(66px+80px)] py-[66px] h-full">
      <div className="flex flex-col md:w-1/2 w-full h-full gap-5">
        <div className=" flex flex-row h-full gap-5">
          <WarmAs />
        </div>
        <div className="flex flex-row h-full gap-5 max-h-[35%]">
          <CheckDetails />
          <Price />
        </div>
      </div>
